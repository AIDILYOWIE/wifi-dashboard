  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="
        w-max flex  items-center px-[20px] py-[10px] rounded-[10px] bg-primary gap-[10px] cursor-pointer    
      ...
      >
        ...
        <svg
          className={`w-[24px] text-background h-[24px] transition-transform duration-200 ${
            isOpen ? "rotate-180" : ""
          }`}
          fill="none"
          stroke="currentColor"
